...
dependencies {
    ...
    "integrationTestImplementation"("ru.ruscrafting.arc:arc-core-integration-testing:2.7.13")
...
plugwright {
    ...
    writeFiles {
        ...
        file("plugins/ArcEcoJobs/config.yml", projectDir.resolve("src/main/resources/config.yml").readText()
            ...
            .replaceFirst("exploration:\n  enabled: false", "exploration:\n  enabled: true")
            .replaceFirst("redemptions:\n  mysql:\n    enabled: false", "redemptions:\n  mysql:\n    enabled: true")
            .replaceFirst("port: 3306", "port: 33306")
            .replaceFirst("database: minecraft", "database: arcecojobs_e2e")
            .replaceFirst("username: minecraft", "username: arcecojobs_e2e")
            .replaceFirst("password: ''", "password: arcecojobs-e2e")
            .replaceFirst("ssl-mode: REQUIRED", "ssl-mode: DISABLED"))
